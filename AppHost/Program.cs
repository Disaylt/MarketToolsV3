...
[
    ...
    builder.AddProject<WB_Seller_Features_Automation_PriceManager_Processor>("WbSellerFeaturesAutomationPriceManagerProcessor"),
    builder.AddProject<MarketToolsV3_DbMigrations_Service>("MigrationService")
];
